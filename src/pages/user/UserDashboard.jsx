...
const UserDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 overflow-hidden flex flex-col">
      {/* HEADER */}
      <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6 border border-gray-200">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1 text-sm sm:text-base">Here's your fitness overview</p>
          </div>
          {trainer && (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
        <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 border border-gray-200">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg font-semibold text-gray-900">{workouts.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 border border-gray-200">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              <p className="text-xs sm:text-sm text-gray-600">Nutrition</p>
              <p className="text-base sm:text-lg font-semibold text-gray-900">{nutritionLogs.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 border border-gray-200">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              <p className="text-xs sm:text-sm text-gray-600">Active Goals</p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 border border-gray-200">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg font-semibold text-gray-900">{progress.length}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          {workouts.length > 0 ? (
            <div className="space-y-2 sm:space-y-3">
              {workouts.slice(0, 3).map((workout) => (
                <div key={workout._id} className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg">
                  <div>
            ...
            <div className="text-center py-6 sm:py-8">
              ...
              <p className="text-xs sm:text-sm text-gray-500">No workouts yet</p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
          ...
          {nutritionLogs.length > 0 ? (
            ...
            <div className="text-center py-6 sm:py-8">
              ...
              <p className="text-xs sm:text-sm text-gray-500">No nutrition data</p>
            </div>
          )}
        </div>
          ...
          {goals.length > 0 ? (
            <div className="space-y-2 sm:space-y-3">
              {goals.slice(0, 2).map((goal) => (
                <div key={goal._id} className="p-2 sm:p-3 bg-gray-50 rounded-lg">
            ...
            <div className="text-center py-6 sm:py-8">
              ...
              <p className="text-xs sm:text-sm text-gray-500">No goals set</p>
            </div>
          )}
        </div>
      </div>
