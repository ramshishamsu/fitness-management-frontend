        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              <h3 className="font-semibold text-gray-900 mb-2">Trainer Management</h3>
              <p className="text-gray-600 mb-4">
                Approve trainer applications and manage trainer profiles and documents.
              </p>
              <Link
                to="/admin/trainers"
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-gray-600 mb-4">
                Monitor payments, withdrawals, and revenue from subscriptions.
              </p>
              <Link
                to="/admin/payments"
