      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl p-6 shadow-lg`}>
            <div className={`w-12 h-12 mb-4 flex items-center justify-center ${isDark ? 'bg-teal-500/10 text-teal-400' : 'bg-teal-500/10 text-teal-600'} rounded-lg`}>
            ...
            <div className="text-center">
              ...
              <p className={`text-sm ${isDark ? 'text-teal-400' : 'text-teal-600'}`}>+2 this week</p>
            </div>
          </div>
          ...
          <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl p-6 shadow-lg`}>
            ...
            <div className="text-center">
              ...
              <p className={`text-sm ${isDark ? 'text-teal-400' : 'text-teal-600'}`}>+12% from last week</p>
            </div>
          </div>
          ...
          <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl p-6 shadow-lg`}>
            ...
            <div className="text-center">
              ...
              <p className={`text-sm ${isDark ? 'text-teal-400' : 'text-teal-600'}`}>+8% from last month</p>
            </div>
          </div>
          ...
          <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl p-6 shadow-lg`}>
            ...
            <div className="text-center">
              ...
              <p className={`text-sm ${isDark ? 'text-teal-400' : 'text-teal-600'}`}>{stats.todaySessions > 0 ? 'On track' : 'No sessions today'}</p>
            </div>
          </div>
        </div>
